...
include ("Modal/md_zona.php");
include ("Modal/md_editzona.php");
       ...
       <ul class="sidebar-menu" data-widget="tree">
            ...
            <li><a href="../pages/almacen.php"><i class="fa fa-cubes"></i> <span >Almacen</span></a></li>
              ...
              <ul class="treeview-menu">
                ...
                <li class="active"><a href=" ../pages/zonas.php"><i class="fa fa-globe"></i><span>Zona</span></a></li>
        ...
        <section class="col-lg-12 connectedSortable">
         ...
         <div class="panel box box-primary">
           ...
           <div class="box-header with-border">
            <strong class="box-title "><i class="fa fa-globe"></i> Zonas</strong>
          </div>
          <div class="box-body">
...
$("#loader").fadeIn('slow');
$.ajax({
url:'./Ajax/buscar/buscar_zona.php',
beforeSend: function(objeto){
$('#loader').html('<img src="../../images/loader.gif"> Cargando...');
},
success:function(data){
$(".zona").html(data).fadeIn('slow');
$('#loader').html('');
}
})
}
...
var abreviacion = $("#abreviacion"+id).val();
...
$("#mod_abreviacion").val(abreviacion);
