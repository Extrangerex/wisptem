...
?>
<div class="modal fade" id="newclienteponnew" tabindex="-1" role="dialog" aria-labelledby="largeModalLabel" aria-hidden="false">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post"  name="gduser" id="gduserN" autocomplete="off">
          ...
          <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="col-sm-3">
                <label>SN</label>
                <input  style="background-color: #87CEEB;" type="text" class="input-sm form-control-sm form-control" name="snn" id="snn" readonly>
              </div>
            ...
            <div class="row">
                 <div class="col-sm-3">
                <label>Board</label>
                <input  style="background-color: #87CEEB;" type="text" class="input-sm form-control-sm form-control" name="boardn" id="boardn" readonly>
              </div>
                 <div class="col-sm-3">
                <label>Port</label>
                <input  style="background-color: #87CEEB;" type="text" class="input-sm form-control-sm form-control" name="portn" id="portn" readonly>
              </div>
                 <div class="col-sm-3">
                <label>Pon Index</label>
                <input  style="background-color: #87CEEB;" type=numeric class="input-sm form-control-sm form-control" name="ponidxn" id="ponidxn" >
              </div>
               <div class="col-sm-3">
                <label>Tipo de Onu</label>
               <select  style="background-color: #87CEEB;" name="onutypen" class="input-sm form-control"   id="onutypen">
        ...
        <div class="modal-footer">
          ...
          <button type="submit" class="btn btn-primary btn-sm" id="btnsaveN"><i class="fa fa-floppy-o"></i> Registrar</button>
        </div>
      </form>
    </div>
  </div>
