          ...
          <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview" style="display:<?php echo $display; ?>">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="#mapa/"><i class="fa fa-wifi"></i> <span>Onu Types</span></a></li>
              ...
              <div class="box">
                ...
                <div class="panel box box-primary" >
                  <div class="box-header with-border">
                    ...
                    <strong class="box-title "><h4>GPON ONUs</h4></strong>
                  </div>
                </div>
...
"mData": null,
"mRender": function (o) {
return '<a href=fijarpon.php?ponidx=' + o.ponidx + '&board='+ o.board +'&port=' + o.port + '&sn=' + o.sn +'><i class="fa fa-check"></i> ' +'Fijar pon'+'</a>';
