...
$montop=intval($_POST['montop']);
$montoc=intval($_POST['montoc']);
$montor=intval($_POST['montor']);
$id=intval($_POST['idf']);
...
$sql="insert into facturas(numero_factura,fecha_factura,id_cliente,id_vendedor,condiciones,total_venta,estado_factura,mora)
	  values($max,'$dat','$id',$idv,'1','$montoc','1',$montop)";
$Records = mysqli_query($con, $sql) or die(mysqli_error());

$sql="update clientesp set fecha_final='$fecha',mora=$montor where id=$id";
$Records = mysqli_query($con,$sql) or die(mysqli_error());
$fec = date("Y-m-d H:i:s");

$detalle = "le cobro RD$ ".$montoc." al cliente ".$cliente." con el ID ".$id;
...
$query = mysqli_query($con,$SI);
                             ...
                             $token = Token;
                             $mensaje = "$fullname le cobro RD$ ".$montoc." al cliente ".$cliente." con el ID ".$id;
