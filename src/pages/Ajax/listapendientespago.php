...
c LEFT JOIN mikrotik m ON m.idmikrotik=c.id_mk LEFT JOIN tipo_servicio t ON c.id_servicio = t.id  WHERE  TIMESTAMPDIFF(DAY, fecha_final , CURDATE()) > 1 and disable='no'";
