...
if (version_compare(PHP_VERSION, '5.3.7', '<')) {
    ...
    require_once("../libraries/password_compatibility_library.php");
		...
		if (empty($_POST['mod_nombre'])){
			$errors[] = "Ingresa nombre del accesorio";
        ...
        
{
		...
		$id = intval($_POST["mod_id"]);
				...
				$detalle = "Actualizó el accesorio $nombre";
				 ...
				 $SI  = "INSERT INTO  logs(user_id,fecha,detalle)
					...
					// write new user's data into database
 					  ...
 					  $sql = "UPDATE accesorios SET nombre='".$nombre."', cantidad='".$cantidad."', precio='".$precio."'  WHERE id='".$id."';";
                    ...
                    if ($query_update) {
                        $messages[] = "El accesorio ha sido modificado con éxito.....";
                    } else {
