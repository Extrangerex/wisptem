...
date_default_timezone_set("America/Santo_Domingo");
	...
	if(empty($_POST['nombre'])){
		...
		$tipoonu=mysqli_real_escape_string($con,(strip_tags($_POST["onutypen"],ENT_QUOTES)));
		...
		$sn=trim(mysqli_real_escape_string($con,(strip_tags($_POST["snn"],ENT_QUOTES))));
		...
		$board=intval($_POST['boardn']);
		$port=intval($_POST['portn']);
		$ponidx=intval($_POST['ponidxn']);
		...
		$query_newpon=mysqli_query($con,$sqlpon);
			...
			$olt = new \OLT\olt();
 			...
 			if ($result == "Successful") {
 				$messages[] = "Onu ha sido fijado con exito..";
