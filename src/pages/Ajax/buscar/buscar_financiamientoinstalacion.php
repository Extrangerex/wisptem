...
$('#lstins_wrapper .dt-buttons').after('<div class="btn-group dt-btns"></div>');

$('#lstins_wrapper .dt-btns').append('<span><button type="button" data-toggle="modal" data-target="#newfinanciamiento" class="btn btn-sm btn-primary" style="margin-left: 10px;"><i class="fa fa-plus"></i> Nuevo financimiento</button></span>');
