...
$delete1=mysqli_query($con,"DELETE FROM planes WHERE id=$id");
...
$('#list-planes_wrapper .dt-btns').append('<span><button type="button" data-toggle="modal" data-target="#newplan" class="btn btn-sm btn-primary" style="margin-left: 10px;"><i class="fa fa-plus"></i> Nuevo plan</button></span>');
