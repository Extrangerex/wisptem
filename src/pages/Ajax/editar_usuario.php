		...
		if (empty($_POST['firstname2'])){
          ...
          )
         {
            require_once ("../../config/db.php");//Contiene las variables de configuracion para conectar a la base de datos
                ...
                $nivel = mysqli_real_escape_string($con,(strip_tags($_POST["nivel2"],ENT_QUOTES)));
				
				$user_id=intval($_POST['mod_id']);
					
               
					// write new user's data into database
                    $sql = "UPDATE users SET firstname='".$firstname."', lastname='".$lastname."', user_name='".$user_name."', user_email='".$user_email."', nivel='".$nivel."'
