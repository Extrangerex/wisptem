       ...
       <ul class="sidebar-menu" data-widget="tree">
            ...
            <li><a href="../pages/almacen.php"><i class="fa fa-cubes"></i> <span >Almacen</span></a></li>
              ...
              <ul class="treeview-menu">
                ...
                <li class="active"><a href=" ../pages/backup.php"><i class="fa fa-hdd-o"></i> <span>Backups</span></a></li>
      ...
      <div class="row">
        ...
        <div class="panel box box-primary">
           ...
           <div class="box-header with-border">
            <strong class="box-title "><i class="fa fa-tachometer"></i> Backups</strong>
          </div>
          <div class="box-body">
              <a  class="btn btn-success btn-sm" href="#" onclick="decargar_backup();">
                                  <i class="fa fa-save fa-2x"></i> Guardar backup
                                  </a>
          </div>
...
function decargar_backup(id)
{
swal({ title: "¿Esta seguro que desea guardar un backup de la base de datos?...",
...
$.post( "descargar.php", { id: id })
.done(function( datas ) {
$('.notydiv').remove();
msgbox("success","Backup guardado",3);
cargar_backups();
});
});
}
function cargar_backups () {
$.ajax({
url:'Ajax/backup_lst.php',
success:function (data) {
$('#backup_lst').html(data);
