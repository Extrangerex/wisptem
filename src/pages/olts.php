...
include ("Modal/md_olt.php");
include ("Modal/md_editOlt.php");
      ...
      <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="../pages/configured.php"><i class="fa fa-wifi"></i> <span>Configured</span></a></li>
                <li><a href="onutype.php/"><i class="fa fa-wifi"></i> <span>Onu Types</span></a></li>
                <li class="active"><a href="../pages/olts.php"><i class="fa fa-server"></i> <span>OLTs</span></a></li>
    ...
    <section class="content">
     ...
     <div class="panel box box-primary">
           <div class="box-header with-border">
            <strong class="box-title "><i class="fa fa-list"></i> OLTS</strong>
          </div>
          <div class="box-body">
...
$("#loader").fadeIn('slow');
$.ajax({
url:'./Ajax/buscar/buscar_olts.php',
...
text: "Si elimina una olt con clientes va perder sus facturas,pagos,tickets,etc que están asociados a este mikrotik!",
type: "warning",
...
$.post( "Ajax/buscar/buscar_olts.php", {id: id})
.done(function( datas ) {
$('.notydiv').remove();
...
var telnetport = $("#telnetport"+id).val();
var hw = $("#hw"+id).val();
...
$("#mname").val(modelo);
$("#molt_ip").val(ip);
$("#mtelnet_port").val(telnetport);
$("#molt_user").val(usuario);
$("#molt_password").val(password);
$("#molt_hardware_version").val(hw);
