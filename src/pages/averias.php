  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="active"><a href="../pages/averias.php"><i class="fa fa-ticket"></i> <span>Averias</span></a></li>
...
-ms-overflow-style: -ms-autohiding-scrollbar;
 ...
 <script>
        ...
        { "mDataProp": 'time'},{ "mDataProp": 'bytes_rcvd'},{ "mDataProp": 'bytes_sent'},
        { "mDataProp": 'host' },{ "mDataProp": 'ifid' }
        ...
        //-------->Boton refrescar
            ...
            eliminar_factura=function(e,d){
               ...
               var id_session = $("#idsession").val();
                ...
                $.post( "Eliminar/eliminar_facturas.php", {id: e})
                .done(function( datas ) {
                $('.notydiv').remove();
