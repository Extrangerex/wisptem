        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview" style="display:<?php echo $display; ?>">
              ...
              <ul class="treeview-menu">
                <li class="active"><a href="../pages/unconfigured.php"><i class="fa fa-wifi"></i> <span>Unconfigured</span></a></li>
              ...
              <div class="box">
                ...
                <div class="panel box box-primary" >
                  <div class="box-header with-border">
                    ...
                    <strong class="box-title "><h4>GPON ONUs Unconfigured</h4></strong>
                  </div>
                </div>
...
"ajax": 'Ajax/unconfiguredlist.php',
...
{ mData: 'board'},
{ mData: 'port' },{ mData: 'ponidx' },{ mData: 'sn'},{ mData: 'md'},
{
"mData": null,
"mRender": function (o) {
return '<a  href="#" data-toggle="modal" data-target="#newclientepon"  onclick=fijar_pon(' + o.ponidx + ',' + o.board +','+ o.port +',"'+ o.sn +'","'+ o.md +'")' + '><i class="fa fa-check"></i> ' +' Fijar Pon Cliente Existente '+'</a>'
 +'<a href="#" data-toggle="modal" data-target="#newclienteponnew"  onclick=fijar_pon2(' + o.ponidx + ',' + o.board +','+ o.port +',"'+ o.sn +'","'+ o.md +'")' + '><i class="fa fa-plus"></i> ' +' Fijar Cliente Nuevo'+'</a>';
