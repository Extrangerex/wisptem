           ...
           <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview active">
              ...
              <ul class="treeview-menu">
                ...
                <li class="active"><a href="../pages/instalaciones.php"><i class="fa fa-calendar"></i> <span>Instalaciones</span></a></li>
              ...
              <div class="box">
                ...
                <div class="panel box box-primary" >
                  <div class="box-header with-border">
                    ...
                    <strong class="box-title "><i class="fa fa-calendar"></i> Registros de las intalaciones</strong>
                  </div>
                </div>
                  ...
                  <div class="box-body">
                    <div class="nav-tabs-custom">
                      <ul class="nav nav-tabs">
                        <li class="active"><a href="#tab_1" data-toggle="tab"><i class="fa fa-user-plus"></i> Registro</a></li>
                        <li><a href="#tab_2" onclick="load_instalaciones();"  data-toggle="tab"><i class="fa fa-calendar"></i>  Instalaciones</a></li>
