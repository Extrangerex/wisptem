       ...
       <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview active">
              ...
              <ul class="treeview-menu">
                ...
                <li class="active"><a href="../pages/anuncios.php"><i class="fa fa-commenting-o"></i> <span>Anuncios</span></a></li>
      ...
      <div class="row">
        ...
        <div class="panel box box-primary">
           ...
           <div class="box-header with-border">
            <strong class="box-title "><i class="fa fa-commenting-o"></i> Anuncios</strong>
          </div>
          <div class="box-body">
...
$("#loader").fadeIn('slow');
$.ajax({
url:'./Ajax/buscar/buscar_anuncio.php',
