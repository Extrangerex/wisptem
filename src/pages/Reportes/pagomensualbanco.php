...
$fi = $_POST["fi"];
$ff = $_POST["ff"];
$productos = mysqli_query($con," select f.condiciones,f.numero_factura,f.fecha_factura,c.nombres,c.apellido,f.total_venta,u.firstname,u.lastname,u.user_id from facturas f left join  clientesp c on c.id=f.id_cliente left join users u on f.id_vendedor=u.user_id where f.condiciones=1 and f.fecha_factura between '$fi' and '$ff' ");
$total = 0;
...
$pdf->Cell(70, 8, '', 0);
$pdf->Cell(100, 8, '   Listado De Todos Los Pagos X Banco', 0);
$pdf->Ln(8);
$pdf->SetFont('Arial', 'B', 8);
$pdf->Cell(10, 8, '', 0);
