...
$pdf->SetFont('Arial', '', 10);
$pdf->Cell(1, 5, '', 0);
$pdf->Cell(130, 5,'Fecha de pago:    '.$fec, 0);
$pdf->Ln(6);
...
$pdf->SetFont('Arial', '', 10);
$pdf->Cell(1, 5, '', 0);
$pdf->Cell(130, 5,'Monto:              RD $'.number_format($pago), 0);
$pdf->Ln(6);
$pdf->SetFont('Arial', '', 10);
$pdf->Cell(1, 5, '', 0);
$pdf->Cell(130, 5,'Monto Rest:     RD $'.number_format($mora), 0);
$pdf->Ln(6);
$pdf->SetFont('Arial', 'B', 10);
$pdf->Cell(1, 5, '', 0);
$pdf->Cell(130, 5,'Total a pagar:   RD $'.number_format($mora+$pago), 0);
$pdf->Ln(6);
$pdf->SetFont('Arial', '', 6);
$pdf->Cell(1, 5, '', 0);
