  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="active"><a href="../pages/sms.php"><i class="fa fa-whatsapp"></i> <span >SMS</span></a></li>
    ...
    <section class="content">
     ...
     <div class="panel box box-primary">
           <div class="box-header with-border">
            <strong class="box-title "><i class="fa fa-whatsapp"></i> Whatsapp</strong>
          </div>
          <div class="box-body">
...
$.ajax({
url:'Ajax/buscar/buscar_smsenviados.php',
success:function(data){
$(".enviados").html(data).fadeIn('slow');
