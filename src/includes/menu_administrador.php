...
if ($nivel == 1){
    ...
    $urlfinan = "../pages/financiamiento.php";
     $urlplantillas = "../pages/plantillas.php";
      ...
      $urlpago = "../pages/pagos.php";
       $urlpromesa = "../pages/promesas.php";
       $urlfactura = "../pages/facturas.php";
        $urlgasto = "../pages/gastos.php";
       $urlproducto = "../pages/productos.php";
...
<ul class="sidebar-menu" data-widget="tree">
  <li class="nav link active">
    <a href="../pages/admin.php">
      <i class="nav link active"></i> <span data-idioma="MENU:inicio">Inicio</span>
    </a>
  </li>
  <li class="treeview">
    <a href="#">
  ...
  <li class="treeview">
    ...
    <ul class="treeview-menu">
      <li><a href="../pages/clientes.php" class="nav link active" ><i class="fa fa-user-plus"></i> <span data-idioma="SUBMENU:usuarios">Clientes</span></a></li>
      ...
      <li><a href="../pages/instalaciones.php"><i class="fa fa-calendar"></i> <span data-idioma="SUBMENU:instalaciones">Instalaciones</span></a></li>
  ...
  <li class="treeview">
    ...
    <ul class="treeview-menu">
      ...
      <li><a href="<?php echo $urlpago; ?>"><i class="fa fa-credit-card"></i> <span data-idioma="SUBMENU:pagos">Registrar pagos</span></a></li>
      <li><a href="<?php echo $urlfactura; ?>"><i class="fa fa-file-pdf-o"></i> <span data-idioma="SUBMENU:facturas">Facturas</span></a></li>
      <li><a href="<?php echo $urlpromesa; ?>"><i class="fa fa-file-pdf-o"></i> <span data-idioma="SUBMENU:facturas">Promesas de pago</span></a></li>
  ...
  <li class="treeview">
    <a href="#"><i class="fa fa-shopping-bag"></i> <span data-idioma="MENU:facturacion">Tienda</span> <i class="fa fa-angle-left pull-right"></i></a>
    <ul class="treeview-menu">

                     
      <li><a href="../pages/productos.php"><i class="fa fa-cart-plus"></i> <span data-idioma="SUBMENU:pagos">Agregar Productos</span></a></li>
      <li><a href="../pages/ventas.php"><i class="fa fa-dollar"></i> <span data-idioma="SUBMENU:facturas">Ventas</span></a></li>
