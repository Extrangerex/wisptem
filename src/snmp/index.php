					...
					<div class='panel panel-mod-black'>
						...
						<div class="panel-body">
							<ul class='nav nav-pill'>
								<li class='nav-item'><a class='active' href="index.php">Community</a>
								</li>
								<li class='nav-item'><a href="add_community.php">Add Community</a>
								</li>
								<li class='nav-item'><a href='search.php'>Search</a>
								</li>
									...
									if(is_null($data)){
										...
										while(($data = $result->fetch_assoc())!=NULL){
											foreach ($data as $key => $value) {
												$link = "<a class='nav-item' href=check_community.php?community=$value>".$value."</a>";
