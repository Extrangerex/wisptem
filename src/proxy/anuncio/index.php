...
$nombres  = "$nombre $apellido";
 $fecha = $row['fecha_final'];
    $fec = date("Y-m-d",strtotime($fecha."+ 6days"));
     $end = date("Y-m-d h:m:i",strtotime($fecha."+ 6days"));
...
<meta http-equiv="Pragma" content="no-cache">
  ...
  <body class="py-5 bg-image-full" style="background-image: url('images/fondos.jpg');">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
      <div class="container">
        <a class="navbar-brand" href="#">PLAYCENTER UNIVERSAL</a>
    ...
    <section class="py-5">
      ...
      <div class="container">
        ...
        <h3  style="color: red;">
        <b>Distinguido(a),  <?php echo $nombres; ?>, se ha generado la factura del mes por un monto de RD $<?php echo $monto ?> nuestro sistema le ortoga hasta el <?php echo $fec; ?> para realizar el pago. 
        <br>
        <b>
          Pasando esa fecha usted debera pagar cargo por reconexion. Evite corte pagando a tiempo
    ...
    <h3>
     <b>
            Para mas informacion, comunicarse al telefono: <img src="images/whatsapp.jpg" width="40px" height="40px" >(809) 582-1212
            <br>
           
        <br>
       Puede realizar su pago en nuestra oficina frente a la doble via de la villa olimpica edif. no 55 proximo Alex Moda en la misma acera.
        <br>
       Tambien pueden hacer transferencia por el Netbanking
        </b> 
         
      </h3>
          <h5>
          <img class="img-fluid d-block mx-auto" src="images/reserva.jpg" width="160px" height="120px"  alt="">
      
       <p align="center" style="color: red;">
       Cuenta: 620-014668-9
        </p>
        <p align="center" style="color: red;">
       Nombre: Franklin Alberto Santos</p>
        </p> 
         ...
         <h5>
            <img class="img-fluid d-block mx-auto" src="images/popular.png" width="160px" height="120px"  alt="">
        <p align="center" style="color: red;">
       Cuenta: 0798928750
        </p>
        <p align="center" style="color: red;">
       Nombre: Franklin Alberto Santos</p>
         ...
         <h5>
            <img class="img-fluid d-block mx-auto" src="images/bhd.jpg" width="160px" height="120px"  alt="">
        <p align="center" style="color: red;">
       Cuenta: 1867332001-6
        </p>
        <p align="center" style="color: red;">
    ...
    <footer class="py-5 bg-dark">
      <div class="container">
        <p class="m-0 text-center text-white">Copyright &copy; JI TECNO SOLUTIONS 2018</p>
      </div>
      <!-- /.container -->
    </footer>
